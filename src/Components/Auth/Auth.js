...
export default function Auth(props) {
    ...
    const RenderComponent = () => {    //setPagen
        ...
        if (pageNumber === 1) {
            ...
            return RenderResetUI({password,setConfirmPassword,setPassword,confirmPassword,resetToken});
        }
        else {
               ...
               <form onSubmit={e=>{
                   ...
                   loginHandler()
                    ...
                    <Box className="modal">
                        ...
                        <div className="pwd">
                            <div className="label">Password</div>
                            <div style={style.pwdHighlight} onClick={()=>console.log('forgotPassword')}>Forgot Password ?</div>
                        </div>
